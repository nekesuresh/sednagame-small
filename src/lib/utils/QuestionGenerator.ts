...
class QuestionGenerator {
  ...
  private buildPrompt(sednaTip: SednaTip, difficulty: Difficulty, combination: {}, factOrMyth: 'FACT' | 'MYTH'): string {
    ...
    if (difficulty === 'easy') {
      difficultyInstructions = `\n- Use very simple, everyday language that anyone can understand.\n- Focus on basic, obvious benefits or common misconceptions.\n- Avoid any technical terms, jargon, or complex concepts.\n- Keep statements short and straightforward.\n- Use familiar examples like "AI helps answer emails" or "AI makes websites work better".`;
    } else if (difficulty === 'medium') {
      difficultyInstructions = `\n- Use moderately complex language with some technical terms.\n- Include specific real-world examples and case studies.\n- Reference actual government departments, agencies, or specific AI applications.\n- Discuss implementation challenges, costs, or specific benefits.\n- Use terms like "machine learning", "automation", "data analysis", "predictive modeling".`;
    } else if (difficulty === 'hard') {
      difficultyInstructions = `\n- Use advanced, technical language with specialized terminology.\n- Reference complex AI concepts like "neural networks", "deep learning", "natural language processing", "computer vision".\n- Discuss sophisticated scenarios involving multiple AI systems working together.\n- Include policy implications, regulatory considerations, or ethical frameworks.\n- Reference specific technical implementations, algorithms, or advanced use cases.\n- Discuss edge cases, failure modes, or complex trade-offs.`;
    }
    if (factOrMyth === 'FACT') {
