...
class QuestionGenerator {
  ...
  private buildPrompt(sednaTip: SednaTip, difficulty: Difficulty, combination: {}, factOrMyth: 'FACT' | 'MYTH'): string {
    ...
    if (factOrMyth === 'FACT') {
      ...
      return `Think of a true and positive statement (a FACT) about AI in government, inspired by the following case study:\n"${sednaTip.tip}"\n- Do NOT quote or restate the tip directly. Instead, create a realistic scenario or example that illustrates the impact or lesson of the tip in a new way.\n- Do NOT mention Sedna or the case study directly.\n- Now, write a common misconception (a MYTH) by negating, exaggerating, misinterpreting, distorting, or misapplying the fact.\n- Phrase the myth in a super scary, dramatic, and fear-mongering way, making AI sound as dangerous, risky, or threatening as possible.\n- Use dramatic language and exaggeration to make the myth sound alarming.\n- Vary the myth topics: include job displacement, privacy invasion, bias/discrimination, cost overruns, technical failures, regulatory violations, public distrust, or other realistic concerns beyond just rogue AI or national security.\n- In your EXPLANATION, thoroughly debunk the myth, provide real-world evidence or reasoning, and reassure the reader that AI is safe, beneficial, and not something to fear.\n- The explanation should be calming, positive, and encourage thoughtful, confident adoption of AI.\n- IMPORTANT: Your explanation MUST include at least one sentence that directly states "AI is not something to be scared of" and explains why (e.g., because it's designed with safety measures, because humans remain in control, because it follows strict guidelines, etc.).\n- After the statement, write ANSWER: MYTH on a new line.\n- Then, write an EXPLANATION (8-10 sentences) that explains why the statement is a myth and what the truth is, using real-world evidence or plausible reasoning. The explanation should always be reassuring and positive about AI.${difficultyInstructions}\n\nYour output must follow this format:\nSTATEMENT: [your myth statement]\nANSWER: MYTH\nEXPLANATION: [your explanation]\n`;
    }
  }
