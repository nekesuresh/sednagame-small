...
<div class="sedna-section-bg min-h-screen overflow-y-auto flex items-center justify-center">
	<div class="w-full max-w-4xl mx-auto flex flex-col md:flex-row bg-white/80 rounded-2xl shadow-lg overflow-hidden">
		<!-- Form Area -->
		<div class="w-full md:w-1/2 p-6 md:p-10 overflow-y-auto max-h-screen">
			...
			<div class="sedna-card p-0 shadow-none bg-transparent">
		...
		<!-- Info/Illustration Area -->
		<div class="hidden md:flex w-1/2 items-center justify-center bg-gradient-to-br from-sedna-cool-blue via-sedna-bright-yellow to-sedna-orange p-10">
			<div class="text-center">
				<div class="text-7xl mb-6">🤖</div>
				<h2 class="text-2xl font-retro-bold text-white mb-4 drop-shadow-lg">Welcome to AI or A-Lie!</h2>
				<p class="text-lg text-white/90">Get ready to test your knowledge and learn about AI in a fun, interactive way. Fill out the form to get started!</p>
			</div>
		</div>
	</div>
</div> 